...
const Skills = () => {
  ...
  const skills = [
    ...
    },
    {
      ...
      category: "Technology",
      description: "Deploy and manage applications using Docker, Kubernetes, and container technologies",
      status: 'emerging' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'high' as const,
      icon: Box,
    ...
    },
    {
      ...
      category: "Technology",
      description: "Design and implement distributed systems using microservices patterns and architectures",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'high' as const,
      icon: Grid3X3,
    ...
    },
    {
      ...
      category: "Technology",
      description: "Design, build, and integrate RESTful APIs and GraphQL services for modern applications",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'high' as const,
      icon: Network,
    ...
    },
    {
      ...
      category: "Technology",
      description: "Optimize application performance, load times, and system efficiency across various platforms",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Gauge,
    ...
    },
    {
      ...
      category: "Technology",
      description: "Manage, optimize, and maintain database systems including SQL and NoSQL databases",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Database,
    ...
    },
    {
      ...
      category: "Technology",
      description: "Build and maintain large-scale data processing systems and pipelines",
      status: 'emerging' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'high' as const,
      icon: HardDrive,
    ...
    },
    {
      ...
      category: "Technology",
      description: "Test system security by simulating cyber attacks and identifying vulnerabilities",
      status: 'emerging' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'high' as const,
      icon: Lock,
    ...
    },
    {
      ...
      category: "Business",
      description: "Implement agile project management practices and facilitate scrum ceremonies",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'high' as const,
      icon: RefreshCw,
    ...
    },
    {
      ...
      category: "Business",
      description: "Conduct market analysis, consumer research, and competitive intelligence",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: Search,
    ...
    },
    {
      ...
      category: "Business",
      description: "Lead organizational transformation and help teams adapt to new processes and technologies",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: ArrowUpRight,
    ...
    },
    {
      ...
      category: "Creative",
      description: "Create digital artwork and illustrations for books, games, advertising, and digital media",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: PaintBucket,
    ...
    },
    {
      ...
      name: "Web Design",
      category: "Creative",
      description: "Design visually appealing and user-friendly websites with modern design principles",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'high' as const,
      icon: Monitor,
    ...
    },
    {
      ...
      name: "Product Design",
      category: "Creative",
      description: "Design physical and digital products that solve user problems with innovative solutions",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Package,
    ...
    {
      id: "radiology-technology",
      name: "Radiology & Imaging Technology",
      category: "Healthcare",
      description: "Operate imaging equipment and assist in diagnostic procedures using X-rays, MRI, and CT scans",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Scan,
    ...
    },
    {
      ...
      category: "Healthcare",
      description: "Assign diagnostic and procedure codes for medical billing and insurance claims",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: FileText,
    ...
    },
    {
      ...
      category: "Healthcare",
      description: "Manage healthcare facilities, coordinate patient services, and oversee medical operations",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Clipboard,
    ...
    {
      id: "robo-advisory",
      name: "Robo-Advisory & Automated Trading",
      category: "Finance",
      description: "Develop and manage automated investment platforms and algorithmic trading systems",
      status: 'emerging' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Bot,
    ...
    },
    {
      ...
      category: "Finance",
      description: "Evaluate creditworthiness, assess loan applications, and manage lending risk",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: CreditCard,
    ...
    },
    {
      ...
      category: "Finance",
      description: "Prepare tax returns, provide tax planning advice, and ensure compliance with tax laws",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: Calculator,
    ...
    },
    {
      ...
      name: "Academic Counseling & Student Support",
      category: "Education",
      description: "Provide academic guidance, career counseling, and student support services",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Users,
    ...
    },
    {
      ...
      category: "Education",
      description: "Provide specialized education services for students with diverse learning needs",
      status: 'stable' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'medium' as const,
      icon: Heart,
    ...
    },
    {
      ...
      category: "Environmental",
      description: "Measure, analyze, and reduce carbon emissions for organizations and projects",
      status: 'emerging' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'medium' as const,
      icon: Leaf,
    ...
    },
    {
      ...
      category: "Environmental",
      description: "Provide expert advice on environmental regulations, compliance, and sustainability",
      status: 'stable' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'medium' as const,
      icon: Compass,
    ...
    {
      id: "corporate-law",
      name: "Corporate Law & Business Legal Services",
      category: "Legal",
      description: "Handle corporate legal matters, mergers, acquisitions, and business transactions",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Building,
    ...
    {
      id: "data-privacy",
      name: "Data Privacy & Protection Law",
      category: "Legal",
      description: "Ensure compliance with data protection regulations and privacy laws",
      status: 'emerging' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'high' as const,
      icon: Lock,
    ...
    {
      id: "forensic-science",
      name: "Forensic Science & Crime Analysis",
      category: "Science",
    ...
    },
    {
      ...
      category: "Science",
      description: "Study celestial objects, space phenomena, and the universe's structure and evolution",
      status: 'stable' as const,
      relevancePeriod: 'Until 2050+',
      demandLevel: 'low' as const,
      icon: Telescope,
    ...
    },
    {
      ...
      category: "Engineering",
      description: "Design and manage complex systems integrating hardware, software, and processes",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Network,
    ...
    },
    {
      ...
      name: "Traffic Management & Urban Planning",
      category: "Transportation",
      description: "Optimize traffic flow, design transportation systems, and plan urban mobility solutions",
      status: 'stable' as const,
      relevancePeriod: 'Until 2045+',
      demandLevel: 'medium' as const,
      icon: Navigation,
    ...
    },
    {
      ...
      category: "Transportation",
      description: "Manage vehicle fleets, optimize routes, and reduce transportation costs",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: Truck,
    ...
    },
    {
      ...
      category: "Communication",
      description: "Design and execute email marketing campaigns with automated workflows",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: Mail,
    ...
    },
    {
      ...
      category: "Communication",
      description: "Plan, coordinate, and execute events, conferences, and corporate gatherings",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: Calendar,
    ...
    },
    {
      ...
      category: "Communication",
      description: "Develop and execute comprehensive brand communication strategies across channels",
      status: 'stable' as const,
      relevancePeriod: 'Until 2040+',
      demandLevel: 'medium' as const,
      icon: Megaphone,
